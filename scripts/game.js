...
(function() {
  var Board, Clear, GameLoop, Menu, addKeyObservers, board, canvas, context, gLoop, gameState, hammer, hammerOptions, height, heightScaling, keyDown, keyUp, menu, mouseListener, points, scaling, state, width, widthScaling;
  ...
  window.waltzLoop = new buzz.sound(["sounds/WaltzLoop.ogg", "sounds/WaltzLoop.mp3", "sounds/WaltzLoop.aac", "sounds/WaltzLoop.wav"]);
