...
(function() {
  var Board, Clear, GameLoop, Menu, addKeyObservers, board, canvas, context, gLoop, gameState, hammer, height, keyDown, keyUp, menu, mouseListener, points, state, waltzLoop, width;
